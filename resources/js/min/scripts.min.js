...
$(document).ready(function(){$.support.placeholder=function(){var e=document.createElement("input");return"placeholder"in e}(),$.support.placeholder&&($("#contact-form li").each(function(){$(this).addClass("js-hide-label")}),$("#contact-form li").find("input, textarea").on("keyup blur focus",function(e){var a=$(this),l=a.parent();"keyup"==e.type?""==a.val()?l.addClass("js-hide-label"):l.removeClass("js-hide-label"):"blur"==e.type?""==a.val()?l.addClass("js-hide-label"):l.removeClass("js-hide-label").addClass("js-unhighlight-label"):"focus"==e.type&&""!==a.val()&&l.removeClass("js-unhighlight-label")}))}),$(document).ready(function(){$("#contact-form").validate()});